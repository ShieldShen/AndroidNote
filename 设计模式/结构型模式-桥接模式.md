...
![桥接模式结构](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334505919_5277.gif "桥接模式结构")
###详细介绍
在桥接模式结构图中包含如下几个角色：
...
![毛笔的实现结构示意图](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334505925_6719.gif "毛笔的实现结构示意图")
...
![跨平台图像浏览系统结构图](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334505400_2839.gif "跨平台图像浏览系统结构图")
...
![图像文件格式和操作系统分析](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334505407_4083.gif "图像文件格式和操作系统分析")
...
![重构后跨平台图像浏览系统结构图](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334506504_5936.gif "重构后跨平台图像浏览系统结构图")
...
![适配器模式与桥接模式的联用示意图](http://wiki.jikexueyuan.com/project/design-pattern-structurized/images/1334507018_4999.gif  "适配器模式与桥接模式的联用示意图")
##总结
